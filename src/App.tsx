...
import { getPlatforms, IonApp, IonRouterOutlet, IonSplitPane } from "@ionic/react";
          ...
          >
            <IonSplitPane contentId="main">
              ...
              <IonRouterOutlet id="main">
                ...
                <Route path={["/favorite", "/favorites"]} render={() => <FavoritesPage />} exact />
                ...
                <Route path="/chapter/:chapterId/:sectionId" render={() => <ChapterPage />} exact />
