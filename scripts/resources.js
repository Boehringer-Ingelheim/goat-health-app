...
mobisplash('resources/splash.png', {
  platform: 'ios',
  background: '#3880ff',
  orientation: 'both',
  contentRatio: 1,
  dest: 'resources/ios/splash',
});
 ...
 * PWA
 */
const SOURCE_PWA_ICON = 'resources/pwa/icon/';
const TARGET_PWA_ICON = 'public/assets/icon/';
const PWA_ICONS = [
...
copyImages(SOURCE_PWA_ICON, TARGET_PWA_ICON, PWA_ICONS);
